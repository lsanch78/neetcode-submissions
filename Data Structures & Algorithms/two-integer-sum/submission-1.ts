class Solution {
    ...
    twoSum(nums: number[], target: number): number[] {
        ...
        // if the current number (indice) is the complimentary of the value (target - val)
        // if true return both indices as answer { complimentary : indice }
